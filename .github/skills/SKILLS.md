...
- [`design-grand-transition-ui`](design-grand-transition-ui/SKILL.md): Design,
  audit, implement, or verify the Lit interface.
...
- [`generate-scene-openai`](generate-scene-openai/SKILL.md): Generate or edit
  scene art and shared raster assets. Use the Flare API for transparency,
...
repair. Preserve unrelated work, generated files, private masters, binaries,
