...
version 18 Latin Extended WOFF2. It adds Unicode mappings for Romanian `Ț`
...
Regenerate it with `py tools/build-romanian-display-font.py` after installing
`fonttools[woff]`. The script checks the source hash and comma outlines before
writing the file.
