...
bar for each portrait. The compact strip can omit the leading article from the
full English name. Text and controls must not intersect a character face,
...
compact gray bubble that shows an ellipsis. Do not show two equal speech cards.
