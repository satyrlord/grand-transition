...
import legacyConciseContent from '../../content/legacy-concise-content-v9.json' with { type: 'json' };
...
export function legacyConciseReplayContext(context: ReplayContext): ReplayContext {
  const catalog = legacyConciseContent as ContentCatalog;
  return { ...context, catalog, locale: catalog.locales[0]! };
}
