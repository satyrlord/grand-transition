...
const phraseIndexes = new WeakMap<readonly Phrase[], ReadonlyMap<string, Phrase>>();

export function phraseIndex(phrases: readonly Phrase[]): ReadonlyMap<string, Phrase> {
